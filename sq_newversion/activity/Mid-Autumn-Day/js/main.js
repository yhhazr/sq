   var now_top = 0;
   //var top_ses = [0,660,1564,2487,3415,4390]
   var top_ses = [0,750,1684,2487,3525,4390]
   //目前导航+目前状态
   ...
   function to_first(){
       $('body,html').animate({scrollTop:top_ses[1]},300);
       find_nav('#nav1');
   }
   ...
   function scrolling(){
		...
		if(($.browser.msie && $.browser.version == 6.0)){
			$('aside').css({position:'absolute'}).animate({top:now_top+40},300);
		}else{
			$('aside').css({position:'fixed',top:40});
		}
   ...
   $(document).ready(function(){
        ...
        $("aside #nav1").click(function(){
            to_first();
        })
        $("aside #nav2").click(function(){
            $('body,html').animate({'scrollTop':top_ses[2]+40},300);
            find_nav(this);
        })
        $("aside #nav3").click(function(){
            $('body,html').animate({'scrollTop':top_ses[3]+40},300);
            find_nav(this);
        })
        $("aside #nav4").click(function(){
            $('body,html').animate({'scrollTop':top_ses[4]+40},300);
            find_nav(this);
        })
		$("aside #nav5").click(function(){
            $('body,html').animate({'scrollTop':top_ses[5]+40},300);
            find_nav(this);
        })
		//点击展开缩放右边导航菜单
        $('.navLeft').click(function(){
            var navRightShow = $('.navRight').is(':visible');
			if(navRightShow){
				$('.navRight').hide();
