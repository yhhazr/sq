...
<table class="line_table" width="100%" cellspacing="0" cellpadding="0" border="0">
	<tbody>
	<s:form name="createRoleSubmit" namespace="/roleManage" action="createRoleSubmit" method="post" theme="simple">
		<tr>
		...
		<tr>
			...
			<td width="20%" height="30" bgcolor="#f2f2f2" align="left"
				class="left_txt2">
				<s:submit key="admin.roleManage.createRole" method="createRoleSubmit" name="Submit" cssClass="button" theme="simple" />
			</td>
		</tr>
