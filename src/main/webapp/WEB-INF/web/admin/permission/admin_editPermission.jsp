...
<table class="line_table" width="100%" cellspacing="0" cellpadding="0" border="0">
	<tbody>
	<s:form name="editPermissionSubmit" namespace="/permManage" action="editPermissionSubmit" method="post" theme="simple">
	<s:hidden name="permission.permId"/>
		...
		<tr>
			...
			<td width="20%" height="30" bgcolor="#f2f2f2" align="left"
				class="left_txt2">
				<s:submit key="admin.permManage.editPermission" method="editPermissionSubmit" name="Submit" cssClass="button" theme="simple" />
			</td>
		</tr>
