...
<body>
	...
	<s:form name="editLogexeImageSubmit" namespace="/logexeImage"
		action="editLogexeImageSubmit" method="post" theme="simple" enctype="multipart/form-data">
		<table class="line_table" width="100%" cellspacing="0" cellpadding="0"
			border="0">
			<tbody>
				<s:hidden name="imageItem.id" ></s:hidden>
				<s:hidden name="imageItem.createDate" ></s:hidden>
				<s:hidden name="imageItem.content" ></s:hidden>
				<tr>
					<td width="20%" height="30" bgcolor="#f2f2f2" align="right"
						class="left_txt2">
						<s:text name="admin.serverResource.uploadFileName"/><s:text name="admin.common.colon"/>
					</td>
					<td width="3%" bgcolor="#f2f2f2">
						&nbsp;
					</td>
					<td width="52%" height="30" bgcolor="#f2f2f2">
						<s:text name="%{#attr.imageItem.content}"></s:text>
					</td>
				</tr>
				<tr>
					<td width="20%" height="30" bgcolor="#f2f2f2" align="right"
				...
				<tr>				
					<td colspan="3" width="100%" height="30" bgcolor="#f2f2f2" align="center"
						class="left_txt2"><s:submit key="admin.homepage.editImage"
							method="editLogexeImageSubmit" name="Submit" cssClass="button"
