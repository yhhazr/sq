...
<body>
	<s:form name="editHtmlSubmit" namespace="/homepageManage"
		action="editHtmlSubmit" method="post" theme="simple">
			...
			<s:hidden name="homepageItem.id"></s:hidden>
				...
				<tr>
					...
					<textarea name="homepageItem.content"
							...
							cols='150' rows='20'><s:property value="homepageItem.content"/></textarea></td>
				</tr>
				<tr>				
					<td colspan="2" width="100%" height="30" bgcolor="#f2f2f2" align="center"
						class="left_txt2"><s:submit key="admin.homepage.editHtml"
							method="editHtmlSubmit" name="Submit" cssClass="button"
