...
<body>
	<s:form name="createTextSubmit" namespace="/homepageManage"
		action="createTextSubmit" method="post" theme="simple" enctype="multipart/form-data">
			...
			<td width="32%" height="30" bgcolor="#f2f2f2">
				...
				<tr>				
					<td colspan="3" width="100%" height="30" bgcolor="#f2f2f2" align="center"
						class="left_txt2"><s:submit key="admin.homepage.createText"
							method="createTextSubmit" name="Submit" cssClass="button"
