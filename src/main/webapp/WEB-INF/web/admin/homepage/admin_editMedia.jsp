...
<body>
	<s:form name="editMediaSubmit" namespace="/homepageManage"
		action="editMediaSubmit" method="post" theme="simple" enctype="multipart/form-data">
			...
			<s:hidden name="homepageItem.id"></s:hidden>
				...
				<tr>				
					<td colspan="3" width="100%" height="30" bgcolor="#f2f2f2" align="center"
						class="left_txt2"><s:submit key="admin.homepage.editMedia"
							method="editMediaSubmit" name="Submit" cssClass="button"
