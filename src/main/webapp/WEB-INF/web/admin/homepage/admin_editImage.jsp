...
<body>
	<s:form name="editImageSubmit" namespace="/homepageManage"
		action="editImageSubmit" method="post" theme="simple" enctype="multipart/form-data">
		<table class="line_table" width="100%" cellspacing="0" cellpadding="0"
			border="0">
			<tbody>
			<s:hidden name="homepageItem.id"></s:hidden>
			<s:hidden name="homepageItem.content"></s:hidden>
				<tr>
				...
				<tr>				
					<td colspan="3" width="100%" height="30" bgcolor="#f2f2f2" align="center"
						class="left_txt2"><s:submit key="admin.homepage.editImage"
							method="editImageSubmit" name="Submit" cssClass="button"
