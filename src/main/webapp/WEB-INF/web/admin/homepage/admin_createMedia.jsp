...
<body>
	<s:form name="createMediaSubmit" namespace="/homepageManage"
		action="createMediaSubmit" method="post" theme="simple" enctype="multipart/form-data">
			...
			<tbody>
				...
				<tr>				
					<td colspan="3" width="100%" height="30" bgcolor="#f2f2f2" align="center"
						class="left_txt2"><s:submit key="admin.homepage.createMedia"
							method="createMediaSubmit" name="Submit" cssClass="button"
