...
<body>
	<s:form name="createGameSubmit" namespace="/gameDate"
		action="createGameDateSubmit" method="post" theme="simple"  enctype="multipart/form-data">
			...
			<tbody>
				...
				<tr>
					...
					<td width="90%" height="30" bgcolor="#f2f2f2">
						<s:textfield name="gameDate.orderNum" lable="" value="0"/>
						<span
						class="login_txt_bt"> <s:fielderror cssStyle="color:red">
