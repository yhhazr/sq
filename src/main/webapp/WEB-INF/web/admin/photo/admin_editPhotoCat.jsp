...
<body>
<s:form name="editPhotoCatSubmit" namespace="/photoManage" action="editPhotoCatSubmit" method="post" theme="simple" enctype="multipart/form-data">
		...
		<tr>
			...
			<td width="32%" height="30" bgcolor="#f2f2f2">
				<s:textfield name="photoCat.catName" cssClass="editbox4" size="20"/>
		...
		<tr>
			<s:hidden name="photoCat.imageUrl"></s:hidden>
			<s:hidden name="photoCat.catId"></s:hidden>
			<td width="20%" height="30" bgcolor="#f2f2f2" align="right"
				class="left_txt2">
		...
		<tr>
			...
			<td width="20%" height="30" bgcolor="#f2f2f2" align="left"
				class="left_txt2">
				<s:submit key="admin.photo.editPhotoCat" method="editPhotoCatSubmit" name="Submit" cssClass="button" theme="simple" onclick="showdiv('数据提交中,请稍候........ ')"/>
			</td>
		</tr>
		</tbody>
		</table>
