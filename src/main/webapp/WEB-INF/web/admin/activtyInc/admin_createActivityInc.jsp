...
<body>
	<s:form name="createActivityIncSubmit" namespace="/activityIncManage"
		action="addActivityInc" method="post" theme="simple"
		...
		<table class="line_table" width="100%" cellspacing="0" cellpadding="0"
			...
			<tbody>
				...
				<tr>
					...
					<td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
					<td width="32%" height="30" bgcolor="#f2f2f2">
						<s:file name="filedata" accept="test/*"></s:file> 
						<span class="login_txt_bt">
							<s:fielderror cssStyle="color:red">
				...
				<tr>
					<td colspan="3" width="100%" height="30" bgcolor="#f2f2f2"
						align="center" class="left_txt2"><s:submit
							key="admin.activityInc.createActivityInc" method="addActivityInc"
