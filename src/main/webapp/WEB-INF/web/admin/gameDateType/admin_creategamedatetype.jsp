...
<body>
	<s:form name="addGameDataTypeSubmit" namespace="/gameDataType"
		action="addGameDataTypeSubmit" method="post" theme="simple"  enctype="multipart/form-data">
			...
			<tbody>
				...
				<tr align="left">
					...
					<td width="90%" height="30" bgcolor="#f2f2f2"><s:select
						...
						class="login_txt_bt"> <s:fielderror cssStyle="color:red">
								<s:param>dataType.parentId</s:param>
							</s:fielderror> </span></td>
				</tr>
				...
				<tr>
					<td  width="10%" height="30" bgcolor="#f2f2f2" align="center"
						class="left_txt2"><s:text name="admin.gameDate.orderID" /> <s:text
							name="admin.common.colon" /></td>
					<td width="90%" height="30" bgcolor="#f2f2f2">
						<s:textfield name="dataType.orderId" lable="" value="0"/>
						<span
						class="login_txt_bt"> <s:fielderror cssStyle="color:red">
				...
				<tr>
					...
					<td colspan="2" width="100%" height="30" bgcolor="#f2f2f2" align="center"
						class="left_txt2"><s:submit key="admin.gameData.addType"
							method="addGameDataTypeSubmit" name="Submit" cssClass="button"
