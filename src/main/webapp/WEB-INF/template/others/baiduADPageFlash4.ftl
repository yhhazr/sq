...
<head>
	...
	<link rel="stylesheet" href="${staticHost}/css/baiduADFlashwithplayerNum.css?v=${version}" charset="utf-8"/>
<style type="text/css">
...
<body>
	...
	<div class="dvflash" style="display: ;">
		<div class="panel reg"  id="regtable" style="display: none;">
			...
			<div class="xf-tab-login">
				<p id="onlinePlayerNum" style="text-align: center;color: yellow;font-size:14px;">&nbsp</p>	
		...
		<object id="falsh1" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1000" height="600">
			<param name="movie" value="${imageHost[0]}/flash/ads1_bg.swf?v=${version}">
			...
			<!--[if !IE]>-->
			<object type="application/x-shockwave-flash" data="${imageHost[0]}/flash/ads1_bg.swf?v=${version}" width="1000" height="600">
			  <!--<![endif]-->
			  <param name="quality" value="high">
			  <param name="wmode" value="transparent">
			  <param name="swfversion" value="9.0.45.0">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			if(remote_ip_info&&remote_ip_info.province&&remote_ip_info.city)
			$("#onlinePlayerNum").html(remote_ip_info.province+"省"+remote_ip_info.city+"市  女性在线玩家:  "+"<span style='color:red'>"+getRandomNumber(20000,25000)+"人</span>");
		});
